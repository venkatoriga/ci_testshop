...
import { new_Medical,new_industrial, maximumValue,genuineBuyers,quickSell } from '../../../helpers/Icons'
...
const NewSell = () => {
    const items=[{imagesrc:new_industrial({width:60 ,height:60}),title:"Industrial Equipment",para:"Over 1500 daily visitors",navi:`/sell/machine-detail?Segment=${'MSME'}`},
    {imagesrc:new_Medical({width:60, height:60}),title:"Medical Equipment",para:"Over 500 + Equipment sold",navi:`/sell/machine-detail?Segment=${'HealthCare'}`}
    ]
    ...
    const advantageData = [
      ...
      const listofdata=[
        ...
        {title:"Equipment Financing",message:"Explore hassle-free loan and lease options for your next purchases",imageurl:"/asset/f_other_benifit2.svg",btnname:"Apply Now",navigate:'/finance'},
