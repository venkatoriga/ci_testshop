...
const ContactUs = () => {
  ...
  const selectedCategoryType = location.state?.selectedCategoryType;
  const enteredPincode = location.state?.enteredPincode;
  const OthersValue = location.state?.OthersValue;
    ...
    <>
      <div className='container-fluid p-0 pb-5 mb-5 m-0 flex-column'>
        <div className="container-fluid tablet-d-padding m-0 bg-gray">
          <div className="max-container p-0 my-5">
            ...
            <div className="col-lg-5 col-md-12 col-12 p-0">
              ...
              <div className="col-lg-7 col-md-12 col-12 p-0 ">
                <div className={`${isSmallScreen ? "d-flex justify-content-center" : "contactusForm"} my-5`} >
                  <Form selectedCategoryType={selectedCategoryType} enteredPincode={enteredPincode} OthersValue={OthersValue} serviceName={serviceName}/>
                </div>
              </div>
            </div>
          </div>
