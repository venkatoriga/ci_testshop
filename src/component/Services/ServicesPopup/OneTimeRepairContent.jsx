...
import OneTimeRepairContentForm from './OneTimeRepairContentForm';
const OneTimeRepairContent = () => {
    const heading="One Time Repair";
...
export default OneTimeRepairContent