...
const NewService = () => {
  ...
  const items = [
    ...
    const product={  imgurl:"/origaReach.svg",heading: "We service all kinds of CNC Machine Tools",
    para: "From CNC, Turning Centre, VMC and many more"}
    const topSliderData = [
    ...
    const advantageData = [
      ...
      const listofdata=[
        ...
        {title:"Equipment Financing",message:"Explore hassle-free loan and lease options for your next purchases",imageurl:"/asset/f_other_benifit2.svg",btnname:"Book Now",navigate:'/finance'},
        {title:"Tools, Spares & Consumables",message:"Explore a Range of Quality Products and Brands for smooth operations.",imageurl:"/asset/f_other_benifit3.svg",btnname:"Buy Now",navigate:'/buy'},
        // {title:"Buy Used Equipment",message:"Find high-quality, pre-owned machines for your business needs at competitive prices.",imageurl:"/asset/f_other_benifit1.svg",btnname:"Buy Now",navigate:'/buy'},
        // {title:"Equipment Financing",message:"Explore hassle-free loan and lease options for your next purchases",imageurl:"/asset/f_other_benifit2.svg",btnname:"Book Now",navigate:'/finance'},
