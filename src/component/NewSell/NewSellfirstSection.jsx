...
const NewSellfirstSection = ({benifit}) => {
    ...
    <div className="col-lg-5 col-md-12 d-flex align-items-center">
        ...
        <img src={benifit.step1} alt={benifit.step1}/>
            ...
            <div className='btn-left-to-right-992' style={{paddingTop:"4px"}}>
                <button className="button heading-600-16-14" onClick={ () => navigate(`/sell/machine-detail`)} >{benifit.btn1}</button>
            </div>
        </div>
...
<div className="row mt-60 ">
    ...
    <div className="col-lg-5 col-md-12 d-flex align-items-center">
        ...
        <img src={benifit.step2} alt={benifit.step2}/>
            ...
            <div className='btn-left-to-right-992' style={{paddingTop:"4px"}}>
                <button className="button" onClick={ () => navigate(`/sell/machine-detail`)} >{benifit.btn2}</button>
            </div>
        </div>
    </div>
</div>
...
<div className="col-lg-5 col-md-12 d-flex align-items-center">
    ...
    <img src={benifit.step3} alt={benifit.step3}/>
        ...
        <div className='btn-left-to-right-992' style={{paddingTop:"4px"}}>
            <button className="button heading-600-16-14" onClick={ () => navigate(`/sell/machine-detail`)} >{benifit.btn3}</button>
        </div>
    </div>
...
<div className="col-lg-5 col-md-12 d-flex align-items-center">
    ...
    <img src={benifit.step4} alt={benifit.step4}/>
        ...
        <div className='btn-left-to-right-992' style={{paddingTop:"4px"}}>
            <button className="button" onClick={ () => navigate(`/sell/machine-detail`)} >{benifit.btn4}</button>
        </div>
    </div>
</div>
</div>}
...
export default NewSellfirstSection