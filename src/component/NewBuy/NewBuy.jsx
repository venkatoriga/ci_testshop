...
const advantageData = [
  ...
  const listofdata=[
    {title:"Equipment Financing:",message:"Explore hassle-free loan and lease options for your next purchases",imageurl:"/asset/f_other_benifit1.svg"},
    {title:"Sell Used Equipment",message:"Streamline the process of selling surplus inventory by listing it easily on our website",imageurl:"/asset/f_other_benifit2.svg"},
