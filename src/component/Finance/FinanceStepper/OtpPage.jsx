...
const OtpPage = ({ phoneNumber, setloading, setpendingresponse, setShowFinancePopup, setShowRemainingField,setotpvalidation }) => {
            ...
            try {
                ...
                if (OTP_message === 'OTP verification was successful!') {
                    try {
                        ...
                        console.log('phoneNo Response----->', responseData);
